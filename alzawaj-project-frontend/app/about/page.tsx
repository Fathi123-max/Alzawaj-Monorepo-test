        ...
        <div className="max-w-4xl mx-auto mb-16">
          <Card className="border-2 border-primary-light shadow-lg">
            <CardHeader className="text-center pb-4">
              <CardTitle className="text-page-title font-heading text-primary mb-2 arabic-optimized">
                رسالتنا ورؤيتنا
              </CardTitle>
            </CardHeader>
            <CardContent className="space-y-6 text-body-large leading-relaxed text-text-secondary arabic-optimized prose-arabic">
              <p>
                ...
                المستطاع من خلوة واختلاط وفتح ذرائع الافساد والرذيلة والعون على
                الفحش والفاحشة. وتقديم خدمة متوافقة مع الاسلام وأخلاقه ومبادؤه
                النبيلة التي يدعو لها وعلى أساسها الفضيلة و العفاف والاعفاف وسد
                سبل الفتنة والتلاعب بالأعراض.
              </p>

              <p>
                بالإضافة لحرصنا على النصيحة في ذلك متى ما اقتضتها الحاجة في
                التوفيق للزواج و على الأمر بالمعروف والنهي عن المنكر والسعي لنشر
                أسس الثقافة الزوجية الشرعية السليمة التي تقوم عليها الزيجات
                الناجحة والبناء الأسري السليم بداية من لَبِنَتهِ الأولى ألا وهي
                الزواج.
              </p>
              ...
              <div className="bg-primary-subtle p-6 rounded-lg border border-primary-light mt-8">
                ...
                <p className="text-body text-primary-safe arabic-optimized text-pretty">
                  ...
                  والسداد والقبول وأن يجعلنا مفاتيح للخير مغاليق للشر في كل وقت
                  وحين وما توفيقنا الا بالله.
                </p>
              </div>
            </CardContent>
          </Card>
