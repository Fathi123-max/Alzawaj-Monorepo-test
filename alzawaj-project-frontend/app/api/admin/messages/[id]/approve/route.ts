// Admin Messages API - Approve a pending message
...
export async function POST(
  ...
  try {
    console.log("✅ Admin approve message endpoint called");
    ...
    if (!backendResponse.ok) {
      ...
      return NextResponse.json(
        {
          success: false,
          message: responseData.message || "حدث خطأ أثناء الموافقة على الرسالة",
    ...
    return NextResponse.json({
      success: true,
      data: null,
      message: responseData.message || "تمت الموافقة على الرسالة بنجاح",
    });
  } catch (error: any) {
