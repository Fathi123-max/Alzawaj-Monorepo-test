// Marriage Requests API - Mark Request as Read
// POST /api/requests/read/[requestId]
...
export async function POST(
  ...
  try {
    ...
    console.log(`👁️ Mark as read endpoint called for request: ${requestId}`);
    ...
    const validationResult = markAsReadSchema.safeParse(requestData);
    ...
    if (!backendResponse.ok) {
      ...
      return NextResponse.json(
        {
          success: false,
          message: responseData.message || "حدث خطأ أثناء تحديث حالة القراءة",
    ...
    console.log("✅ Request marked as read successfully");
    return NextResponse.json({
      success: true,
