// Marriage Requests API - Get Sent Requests
...
export async function GET(request: NextRequest) {
  try {
    console.log("📤 Get sent requests endpoint called");
    ...
    const apiUrl = `${backendUrl}/requests/sent?page=${page}&limit=${limit}`;
    ...
    if (!backendResponse.ok) {
      ...
      return NextResponse.json(
        {
          success: false,
          message: responseData.message || "حدث خطأ أثناء جلب الطلبات المرسلة",
    ...
    console.log("✅ Sent requests fetched successfully");
