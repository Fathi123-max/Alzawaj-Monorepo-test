...
export const metadata: Metadata = {
  ...
  description:
    "منصة الزواج الإسلامية الرائدة في المنطقة العربية. ابحث عن شريك الحياة المناسب وفق الشريعة الإسلامية مع ضمان الأمان والخصوصية التامة.",
  keywords: [
    "زواج إسلامي",
    "الزواج السعيد",
  ...
  authors: [
    { name: "فريق الزواج السعيد", url: "https://alzawajalsaeid.vercel.app/" },
  ],
  ...
  openGraph: {
    ...
    description:
      "انضم إلى أعضاء منصة الزواج الإسلامية الرائدة. ابحث عن شريك الحياة المناسب وفق الشريعة الإسلامية مع ضمان الأمان والخصوصية التامة.",
  ...
  twitter: {
    ...
    description:
      "ابحث عن شريك الحياة المناسب وفق الشريعة الإسلامية. آمان وخصوصية تامة.",
    images: ["/logo.png"],
  },
  robots: {
    index: true,
