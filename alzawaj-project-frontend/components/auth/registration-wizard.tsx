...
export function RegistrationWizard({
  ...
  // Check localStorage for terms acceptance on component mount
  const checkTermsAcceptance = () => {
    if (termsUtils.hasAcceptedTerms()) {
      console.log("Terms already accepted, skipping dialog");
      setTermsAccepted(true);
      setShowTermsDialog(false);
    } else {
      console.log("Terms not accepted, showing dialog");
    ...
    const steps = [
      {
        id: 1,
        title: "إنشاء الحساب",
        description: "البريد الإلكتروني، الهاتف، كلمة المرور",
      },
      {
        id: 2,
