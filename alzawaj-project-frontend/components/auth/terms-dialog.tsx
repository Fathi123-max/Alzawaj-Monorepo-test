...
export function TermsDialog({ isOpen, onAccept, onClose }: TermsDialogProps) {
  ...
  const handleAccept = () => {
    if (hasAccepted && hasScrolledToBottom) {
      // Save acceptance to localStorage using utility function
      termsUtils.acceptTerms();
      onAccept();
    }
  };
        ...
        <CardContent className="flex-1 overflow-hidden p-0">
          ...
          >
            <div className="space-y-4 sm:space-y-6 text-gray-800 leading-relaxed">
              ...
              {/* Conclusion */}
              <div className="bg-secondary-color-50 p-3 sm:p-4 rounded-lg border-r-4 border-secondary-500">
