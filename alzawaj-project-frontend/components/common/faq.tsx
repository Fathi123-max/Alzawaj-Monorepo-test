        ...
        <div className="space-y-4">
          {displayedFAQs.map((faq, index) => (
            <Card key={index} className="overflow-hidden">
              <CardContent className="md:p-4 sm:p-2">
                <button
                  onClick={() => toggleFAQ(index)}
                  className="w-full text-right p-1 hover:bg-gray-50 transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-primary focus:ring-inset"
                >
