...
export function DashboardLayout({ children }: DashboardLayoutProps) {
  ...
  // Get user initial - consistent between server and client
  const getUserInitial = () => {
    if (!isInitialized) {
      return "U"; // Neutral placeholder during initialization
    }
          ...
          <div className="flex justify-between items-center h-16 sm:h-20">
            ...
            <div className="flex items-center gap-2 sm:gap-4">
              ...
              <div className="relative">
                <button
                  className="flex items-center gap-2 text-sm text-gray-700 hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-primary rounded-lg p-2"
                  ...
                  <li key={item.name}>
                    <Link
                      ...
                      className={`flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-medium transition-all duration-200 transform hover:scale-105 ${
                        isActive(item.href)
                          ? "bg-gradient-to-r from-primary to-primary-600 text-white shadow-lg hover:text-white hover:shadow-xl border border-primary/20"
                          : "text-gray-600 hover:text-gray-900 hover:bg-gradient-to-r hover:from-gray-50 hover:to-gray-100/50 hover:shadow-md border border-transparent hover:border-gray-200/50"
                      }`}
                    >
                      <div className="w-5 h-5">
                        {item.icon === "home" && (
