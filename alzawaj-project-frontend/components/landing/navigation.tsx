...
export function LandingNavigation() {
  ...
  return (
    <nav
      className={`bg-white shadow-sm border-b border-border sticky top-0 z-50 transition-all duration-300 ${isScrolled ? "nav-shrink" : ""}`}
    >
      <div className="max-w-7xl mx-auto">
        <div
          className={`flex justify-between items-center transition-all duration-300   ${isScrolled ? "h-4 md:h-6" : "h-8 md:h-12"}`}
        >
