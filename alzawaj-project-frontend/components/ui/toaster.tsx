...
const CustomToast = ({
  ...
  const typeClasses = {
    ...
    warning:
      "border-amber-500 bg-gradient-to-r from-amber-500 to-orange-600 text-white shadow-lg shadow-amber-500/30",
    info: "border-blue-500 bg-gradient-to-r from-blue-500 to-cyan-600 text-white shadow-lg shadow-blue-500/30",
  };
