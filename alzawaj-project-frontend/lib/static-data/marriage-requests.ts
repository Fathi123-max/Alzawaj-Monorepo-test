...
// Helper function to create MarriageRequestUser from profile data
const createMarriageRequestUser = (profileData: {
  id: string;
  name: string;
}): MarriageRequestUser => {
...
// Helper function to convert Profile to MarriageRequestUser
const profileToMarriageRequestUser = (
  profile: Profile,
): MarriageRequestUser => {
...
export const staticReceivedRequests = [
  {
    id: "req_001",
    senderId: "user_101",
    ...
    sender: createMarriageRequestUser({
      id: "user_101",
...
export const staticSentRequests = [
  {
    id: "req_201",
...
export const mockRequestsApi = {
  ...
  async getRequestById(requestId: string) {
    ...
    let request = staticReceivedRequests.find(
      (req) => req.id === requestId,
    ) as any;
    if (!request) {
      request = staticSentRequests.find((req) => req.id === requestId) as any;
    }
