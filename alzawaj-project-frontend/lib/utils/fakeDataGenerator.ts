...
export function generateFakeRegistrationData(
  ...
  const baseData: RegistrationData = {
    ...
    religiousLevel: faker.helpers.arrayElement([
      "practicing",
      "very-religious",
      "moderate",
    ]),
    isPrayerRegular: faker.datatype.boolean(0.8),
    areParentsAlive: faker.helpers.arrayElement([
      "both",
      "father",
      "mother",
      "none",
    ]),
    parentRelationship: faker.helpers.arrayElement([
      "excellent",
      "good",
      "average",
    ]),
    ...
    appearance: faker.helpers.arrayElement([
      "very-attractive",
      "attractive",
      "average",
    ]),
    ...
    relocationPlans: faker.helpers.arrayElement([
      "مستعد للانتقال داخل المملكة",
      "أفضل البقاء في مدينتي",
      "مستعد للانتقال لأي مكان",
    ]),
    marriageTimeline: faker.helpers.arrayElement([
      "خلال 3-6 أشهر",
      "خلال 6-12 شهر",
      "خلال سنة",
    ]),
  ...
  if (isMale) {
    return {
      ...
      financialSituation: faker.helpers.arrayElement([
        "excellent",
        "good",
        "average",
      ]),
      housingLocation: city,
      housingOwnership: faker.helpers.arrayElement([
        "owned",
        "rented",
        "family-owned",
      ]),
    ...
    return {
      ...
      guardianRelationship: faker.helpers.arrayElement([
        "father",
        "brother",
        "uncle",
      ]),
